...
public class MultilingualTesterApp {

    private static final Logger log = LoggerFactory.getLogger(MultilingualTesterApp.class);

    private final Environment env;

    public MultilingualTesterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes multilingualTester.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MultilingualTesterApp.class);
